 ...
 */
private fun cameraAngleIsNotCorrect(
    angel: Double,
...
/**
 * Determine if the camera should be moved closer or further away from the user's face.
 */
private fun cameraDistanceIsNotCorrect(
